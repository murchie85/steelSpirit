...
class smallWorld():
	def __init__(self,gui,game):
		...
		self.objectives        = {'destroyAAQ1': {'objective':'notSet','targetObjects':[], 'status': 'notStarted', 'nextObjective':'destroyTanksQ1','pauseGame':False, 'startMessage':'First up, take out the enemy AA, good luck!', 'completionMessage': 'Great job!','activeQuandrant': {'x':0 ,'w':self.mapw ,'y':0 ,'h':self.maph} }
	...
	def initMe(self,gui,game):
		...
		self.player.x = activeQuandrant['x']+ 0.9*activeQuandrant['w']
		self.player.y = activeQuandrant['y']+ 0.99*activeQuandrant['h']
